...
function consulta(){
    ...
    .then((salida)=>{datosjson = salida;
     ...
     //se coloca 0 peroque dolares esta en la posicion 0 del array,esto es todo lo que esta dentro de las primeras llaves
     saldo_usd.textContent = 'Saldo $US: '+salida.saldo[0].monto;

     document.getElementById("saldo_eu")
     //se coloca 1 peroque euros esta en la posicion 1 del array,esto es todo lo que esta dentro de las segundas llaves
